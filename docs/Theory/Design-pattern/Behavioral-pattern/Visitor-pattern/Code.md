...
原链接：[**Visitor** in Python](https://refactoring.guru/design-patterns/visitor/python/example)。原文代码使用了python3.5中引入的[Type Hints](https://www.python.org/dev/peps/pep-0484/)特性，所以需要在python3.5及以上版本才能够执行。
