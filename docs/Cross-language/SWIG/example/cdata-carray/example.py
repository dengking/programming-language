...
def cdata(ptr, nelements=1):
    return _example.cdata(ptr, nelements)

def memmove(data, indata):
    return _example.memmove(data, indata)
class intArray(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, nelements):
        _example.intArray_swiginit(self, _example.new_intArray(nelements))
...
# Register intArray in _example:
_example.intArray_swigregister(intArray)
